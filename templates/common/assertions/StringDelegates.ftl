...
<#if (stringDelegate.interface??)><#list stringDelegate.interface as sdi>
     ...
     */
    global ${com.classPrefix(supportedAssert.type)}Assert ${stringDelegate.method}(<#if (stringDelegate.interface??)><#list stringDelegate.interface as sdi>${sdi.type} ${sdi.name}<#sep>, </#list></#if>) {
